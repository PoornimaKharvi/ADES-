...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="modal add-edit-modal" id="EditModal" role="dialog" style="min-width: 300px;">
                <div class="modal-dialog modal-dialog-centered" style="width: 750px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="modal-table1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="DdlRegion" runat="server" CssClass="form-control" TabIndex="8" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="modal-footer">
                            <input type="submit" value="Update" class="btn AddEditBtn" tabindex="9" id="btnedit" onclick="return EmpValidation();" onserverclick="btnedit_ServerClick" runat="server" />
                            <input type="button" value="Cancel" class="btn btn-danger CancelBtn" tabindex="10" id="btneditcancel" onclick="editcancel()" data-dismiss="modal" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            ...
            <div class="OuterDiv">
                <div class="InnerDiv">
                    <span>Employee ID</span>
                    <asp:TextBox ID="txtFilterEmpID" runat="server" CssClass="form-control" Width="220px" AutoCompleteType="Disabled" list="EList" />
                    <datalist id="EList" runat="server" clientidmode="static" />
                </div>
            </div>
            <br />
            ...
            <div class="OuterDiv">
                <div class="InnerDiv">
                    ...
                    <asp:ListBox ID="ddlFilterDept" runat="server" CssClass="multiDropdown form-control txtsize" ClientIDMode="Static" SelectionMode="Multiple" />
                </div>
            </div>
            <br />
