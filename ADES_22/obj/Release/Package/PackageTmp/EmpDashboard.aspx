        ...
        <ContentTemplate>
            <div class="divStyle">
                ...
                <table class="table">
                    <tr>
                        <td>
                            <span class="lbltxt">Assigned to me </span>
                        </td>
            ...
            <div id="ViewAttachments" class="ViewAttachments" runat="server">
                ...
                <asp:Panel ID="InfoPanel" runat="server" CssClass="PanelCss" ClientIDMode="Static">
                    <div id="PanelBody" runat="server" class="panel-body" style="max-height: 600px; overflow: auto;">
                        ...
                        <asp:GridView ID="GridAttachments" runat="server" CssClass="grid" Width="100%" ClientIDMode="Static" AutoGenerateColumns="false">
                            <Columns>
            ...
            <div class="modal fade add-edit-modal" id="ViewHistoryModal" role="dialog" style="min-width: 500px;">
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            ...
            <div class="OuterDiv">
                <div class="InnerDiv">
                    <span>Status</span><br />
                    <asp:ListBox ID="ddlStatus_CList" runat="server" CssClass="multiDropdown form-control txtsize" Height="50px" ClientIDMode="Static" SelectionMode="Multiple" />
                </div>
            </div>
            <br />
            <br />
