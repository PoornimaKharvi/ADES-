<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Internal_Issue.aspx.cs" Inherits="ADES_22.Internal_Issue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="modal add-edit-modal" id="InfoProjectModal" role="dialog" style="min-width: 1000px">
                <div class="modal-dialog modal-dialog-centered" style="width: 1120px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="color: black">
                            ...
                            <table class="modal-table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="ddlModule" runat="server" autocomplete="off" class="form-control" list="datalist" tabindex="2" />
                        ...
                        <div class="modal-footer">
                            <input type="submit" value="Add" class="btn AddEditBtn" id="InfoIssue_Yes" onclick="return IssueValidation();" onserverclick="InfoIssue_Yes_ServerClick" runat="server" tabindex="11" />
    ...
    <div class="modal add-edit-modal" id="ViewMoreInfoModal" role="dialog" style="min-width: 300px;">
