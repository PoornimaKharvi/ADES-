                    ...
                    <div id="import" runat="server" class="importdiv">
                        <table id="tbl1" class="filterTable tbl">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFDate" CssClass="form-control textsize1 timepicker" AutoPostBack="true"></asp:TextBox></td>
                                <td>
                                    <asp:Label runat="server">To Date</asp:Label></td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtEDate" CssClass="form-control textsize1 timepicker" AutoPostBack="true"></asp:TextBox>
                                </td>
                                <td>
                        ...
                        <div class="modal  add-edit-modal" id="newEntry1" tabindex="-1">
                                        ...
                                        <table class="modal-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="addDeliveryDate" runat="server" CssClass="form-control textsize timepicker" AutoCompleteType="Disabled"></asp:TextBox>
                                                </td>
                                                <td>
